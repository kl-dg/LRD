...
from data.index_lists import books_by_selected_bookshelf
from control.queries import get_books_by_bookshelf
from ui.info_panel.refresh import refresh_panel
from ui.info_panel.empty_panel import EmptyPanel
from ui.tables.bookshelves_table import BookshelvesTable
...
class BookshelvesTab(QWidget):
	...
	def __init__(self):
		...
		self.books_by_bookshelf_table = BookTable(self, books_by_selected_bookshelf)
