...
from control.queries import get_read_books_by_year, get_read_books_general_statistics, get_reading_status_lists
...
from ui.tables.year_read_table import YearReadTable
...
class ReadingTab(QWidget):
	...
	def current_to_read_tab_settings(self):
		...
		self.currently_reading_table = BookTable(self, books_current_reading)
		self.to_read_table = BookTable(self, books_to_read)
	...
	def read_tab_settings(self):
		...
		self.books_by_year_read_table = BookTable(self, books_read_on_selected_year)
	...
	def wishlist_tab_settings(self):
		...
		self.wishlist_table = BookTable(self, books_wishlisted)
		self.research_books_table = BookTable(self, books_for_reasearch)
	...
	def not_read_tab_settings(self):
		...
		self.books_not_read_table = BookTable(self, books_not_read)
		self.abandoned_books_table = BookTable(self, books_given_up_reading)
