...
from data.index_lists import books_by_selected_year
from control.queries import get_books_by_publishing_year
...
from ui.tables.pubyear_table import PubYearTable
...
class PublishingYearTab(QWidget):
	...
	def __init__(self):
		...
		self.books_by_year_table = BookTable(self, books_by_selected_year)
